...
# You should download and unzip https://github.com/ZhangLabTJU/fastBCR/archive/refs/tags/v1.3.0.zip and set the folder as working directory before running pipeline.
# knitr::opts_knit$set(root.dir = "THE/PATH/TO/FASTBCR/FOLDER")
knitr::opts_knit$set(root.dir = "~/Documents/Rpackage/fastBCR-1.3.0") # Replace with your path.

# Install and library fastBCR
if(!require(devtools)){
  install.packages("devtools") # If not already installed
}
devtools::install_github("ZhangLabTJU/fastBCR", ref = "v1.3.0")
library(fastBCR)
```
...
# For high efficiency, the "min_depth_thre" is increased by 1 for every 100,000 entries of input data.
...
# Set 'paired = TRUE' to use fastBCR-p to infer clonal families from paired BCR sample list. While, defult parameter is "paired = FALSE", meant to inference only by heavy chain.)
