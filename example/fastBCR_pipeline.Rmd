...
# You should download and unzip https://github.com/ZhangLabTJU/fastBCR/archive/refs/tags/v1.1.zip and set the folder as working directory before running pipeline.
